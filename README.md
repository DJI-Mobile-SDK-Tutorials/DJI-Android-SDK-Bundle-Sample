# Android-SDK-Bundle-Sample

## Introduction

In this sample, you will learn how to use the DJI Android SDK with app bundle.
...
Android-SDK-Bundle-Sample is available under the MIT license. Please see the LICENSE file for more info.
